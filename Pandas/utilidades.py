animales = {
    ...
    'Frugívoros':['Ardilla','Mono aullador','Loro','Bonobo','Mosca de la fruta','Macaco','Calandria','Murciélago frugívoro','Iguana','Chimpancé','Tupaya enana','Conejo del campo','Chinche del campo','Perico','Tucán','Gibón','Pacú','Zarigüeya','Gorila','Tortuga terrestre','Zorro volador','Lémur','Tapir','Orangután','Lirón','Mono Tití'],   
    'Rumiantes':['Vaca','Toro','Oveja','Alce','Cabra','Llama','Cebú','Búfalo cafre','Ciervo común','Nilgó','Antílope de cuatro cuernos','Gamo común','Sitatunga','Niala','Ciervo de copete','Anoa de montaña','Bongo','Alce irlandés','Ñu','Venado temazate','Sambar','Gayal','Bisonte estepario','Ciervo porcino','Ciervo de los pantanos','Búfalo de agua','Gacela de Grant','Corzo','Antílope jeroglífico','Candelillo','Venado andino','Bisonte americano','Corzuela','Vicuña','Bisonte europeo','Oryx','Urial','Venado de las Pampas','Uapití','Anoa de llanura','Reno','Apaca','Íbice de los Alpes','Ciervo axis','Impala'],    
    
    'Herbívoros':['Cebra','Oveja','Antílope','Llama','Cabra','Alpaca','Jirafa','Koala','Elefante','Ciervo','Tapir','Ardilla','Vaca','Canguro','Caballo','Cobayo','Rinoceronte','Burro','Conejo','Tortuga'],
    'Carnívoros':['Foca','Hiena','Lince','Gato','Jaguar','Lobo','Gato montés','León','Lobo gris','Comadreja','León marino','Civeta','Coyote','Leopardo','Mangosta','Marta','Cachalote','Tigre siberiano','Ballena azul','Delfín','Tigre de bengala','Ballena jorobada','Oso pardo','Orca','Beluga','Oso polar','Nutria','Narval','Guepardo','Gineta manchada','Perro','Puma','Panda rojo','Pantera negra','Gineta común','Linsangs','Fosa','Murciélago espectral','Mapache','Visón europeo','Murciélago pescador','Demonio de Tasmania','Serval','Morsa','Chacal','Pangolín','Hurón','Glotón','Tejón','Garduña','Kinkajú','Anaconda','Cobra','Tortuga marina','Boa','Pitón','Varano del desierto','Cocodrilo','Tortuga lagarto','Caimán','Dragón de Komodo','Gecko leopardo','Serpiente de coral','Atún','Pez espada','Muskallonga americano','Tiburón blanco','Perca','Marlín','Tiburón martillo','Salmón','Pez gato','Tiburón tigre','Tollo cigarro','Piraña','Tiburón peregrino','Tiburón toro','Barracuda','Aguila arpía','Albatros','Buitre leonado','Águila pescadora','Gaviota','','Buitre quebrantahuesos','Secretario','Halcón','Buitre común','Pingüino','Cuervo','Buitre negro','Pelícano','Cóndor de California','Marabú','Milano','Cóndor andino','Lechuza','Alimoche','Búho','Gavilán pollero'],
    'Omnívoros':['Humano','Seres humanos','Erizo','Mirlo','Perdiz','Flamingo','Bacalao','Gaviota','Garcilla bueyera','Focha','Casuario','Zorzal','Pájaro carpintero','Zorrillo','Perro','Delfín','Grajo','Pez globo','Pinzón','Labeo bicolor','Hormiga','Garza real','Petirrojo','Morena','Jabalí','Cerdo','Tucán','Gorrión','Mono','Urraca','Gallina','Corydora','Zarigüeya','Cacatúa','Cangrejo','Avispa','Pez espiga','Tiburón','Rinoceronte','Langosta','Ballena','Avestruz','Tortugas','Faisán','Cisne','Gatos','Mosca','Bengalí rojo','Oso','Hámster','Cuervos','Ñandú','Bagre','Avutarda','Lémur','Zorro','Armadillo','Pez arquero','Mofeta','Mapache','Gorila','Chimpancé','Ardilla','Ornitorrinco','Emú','Grillo','Avestruces','Ratón','Carpa','Cucaracha','Escarabajo de cementerio','Pavo real','Ganso','Coyote','Piraña','Coatí','Manatí','Grulla','Mojarrita','Ratones','Nutria','Jerbo','Casuarios','Tejón','Tortuga','Tortuga carbonaria','Espátula','Perezoso','Ayeaye','Calamón'],
}
